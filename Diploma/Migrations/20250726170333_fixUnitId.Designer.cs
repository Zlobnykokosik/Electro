...
namespace Diploma.Migrations
{
    ...
    [Migration("20250726170333_fixUnitId")]
    partial class fixUnitId
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Diploma.Models.Add.MountMeterAdd", b =>
                {
                    ...
                    b.HasOne("Diploma.Models.ShortCalc.MountMeterSC", "MountMeterSC")
                        .WithMany()
                        .HasForeignKey("MountMeterSCID");

                    b.Navigation("Meter");

                    b.Navigation("MountMeterArhive");

                    b.Navigation("MountMeterSC");
                });
            ...
            modelBuilder.Entity("Diploma.Models.Add.UnitAdd", b =>
                {
                    b.HasOne("Diploma.Models.Add.MountMeterAdd", "MountMeterAdd")
                        .WithOne("Unit")
                        .HasForeignKey("Diploma.Models.Add.UnitAdd", "MountMeterAddID");
                    ...
                    b.HasOne("Diploma.Models.ShortCalc.UnitSC", "UnitSC")
                        .WithMany()
                        .HasForeignKey("UnitSCID");
